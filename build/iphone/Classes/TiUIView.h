...
/**
 Base class for all OmniMobileSalesApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the OmniMobileSalesApp view hierarchy (such as wrapped iOS UIViews) was touched.
