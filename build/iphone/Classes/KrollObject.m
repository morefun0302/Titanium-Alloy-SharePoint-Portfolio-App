...
//@interface OmniMobileSalesAppObject : NSObject
//@end

@interface OmniMobileSalesAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[OmniMobileSalesAppObject class]])
		{
			for (NSString *key in [[(OmniMobileSalesAppObject*)o modules] allKeys])
			{
