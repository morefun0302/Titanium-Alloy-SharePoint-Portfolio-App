...
//Rare exceptions to indicate a bug in the _omnimobilesalesapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for OmniMobileSalesApp proxies.
 */
