...
// in simulator we redefine to format for OmniMobileSalesApp Developer console
...
{\
	NSString * exceptionName = [@"org.omnimobilesalesapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.omnimobilesalesapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIOmniMobileSalesAppNativeItemNone = -1, 
	UIOmniMobileSalesAppNativeItemSpinner = -2,
	UIOmniMobileSalesAppNativeItemProgressBar = -3,
	
	UIOmniMobileSalesAppNativeItemSlider = -4,
	UIOmniMobileSalesAppNativeItemSwitch = -5,
	UIOmniMobileSalesAppNativeItemMultiButton = -6,
	UIOmniMobileSalesAppNativeItemSegmented = -7,
	
	UIOmniMobileSalesAppNativeItemTextView = -8,
	UIOmniMobileSalesAppNativeItemTextField = -9,
	UIOmniMobileSalesAppNativeItemSearchBar = -10,
	
	UIOmniMobileSalesAppNativeItemPicker = -11,
	UIOmniMobileSalesAppNativeItemDatePicker = -12,
	
	UIOmniMobileSalesAppNativeItemInfoLight = -13,
	UIOmniMobileSalesAppNativeItemInfoDark = -14,
	
	UIOmniMobileSalesAppNativeItemDisclosure = -15,
	
	UIOmniMobileSalesAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all OmniMobileSalesApp instances of
