...
@interface OmniMobileSalesAppObject : KrollCoverageObject {
#else
@interface OmniMobileSalesAppObject : KrollObject {
#endif
@private
...
extern NSString * OmniMobileSalesApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	OmniMobileSalesAppObject *_omnimobilesalesapp;
    KrollObject* console;
	BOOL shutdown;
